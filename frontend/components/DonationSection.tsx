...
export default function DonationSection() {
  // State untuk menampung data bank dari API
  ...
  const categories = [
    {
      id: "operasional",
      label: "Operasional",
      desc: "Listrik, Air, Kebersihan & Imam",
    },
    {
      id: "yatim",
      label: "Pendidikan Yatim",
      desc: "Beasiswa & Biaya Sekolah Yatim",
    },
...
Mohon dicek. Terima kasih.`;
    ...
    const url = `https://wa.me/628567861311?text=${encodeURIComponent(
      message
    )}`;
          ...
          <div className="w-full lg:w-3/5">
            <ScrollReveal direction="left">
              ...
              <p className="text-slate-600 mb-8 leading-relaxed">
                Dukung program kebaikan Masjid Al-Huda Cikumpa. Harta tidak akan
                berkurang karena sedekah, melainkan bertambah keberkahannya.
              </p>
                ...
                <div className="p-6 flex flex-col items-center">
                  ...
                  <div className="w-48 h-48 bg-gray-100 border-4 border-white shadow-inner rounded-xl overflow-hidden relative mb-6">
                    {bankDetails.qris_url ? (
                      ...
                      // Tampilan jika belum ada QRIS atau sedang loading
                      <div className="flex flex-col items-center justify-center h-full text-slate-400 p-4 text-center">
                        <span className="text-xs">QRIS belum tersedia</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="w-full bg-slate-50 rounded-xl p-4 border border-dashed border-slate-300 mb-6">
                    ...
                    <div className="flex items-center justify-between bg-white px-3 py-2 rounded border border-gray-200">
                      ...
                      <button
                        onClick={handleCopy}
                        disabled={bankDetails.number === "..."}
                        className="text-navy hover:text-aqua transition-colors focus:outline-none p-1 disabled:opacity-50"
                        title="Salin Nomor"
                      >
                        {copied ? (
                    ...
                    <p
                      className="text-xs text-center text-slate-400 mt-1 uppercase truncate px-2"
                      title={bankDetails.name}
                    >
